...
//     const produitsAvecCalculs = data.commande.Produits.map(produit => {
...
//         pdf.text(`Facture numero : FAC/${data.commande.numero_commande || ""}`, 60, 90);
...
//         pdf.save(`Facture numero : FAC/${data.commande.numero_commande}.pdf`);
//     };
...
//             <h1 className="text-center">Facture-Commande</h1>
//             <section className="bg-white p-2 rounded">
//             <h2 className="text-center">Facture numero : FAC/{data.commande.numero_commande}</h2>
