...
@keyframes moveRight {
    ...
    return (
        <div className="position-relative col-md-12">
            <div className=" position-absolute  square" id='square' style={{width: "100px", heidth: "100px", background: "yellow", top: "100px", right: "1000px"}}>
                <p className='bg-white'>COMMENT FAIRE</p>
            </div>
            <div className="wrapper">
                <div id="tunnel" style={{width: "100px", height: "100px", background: "yellow"}}> LE TUNNEL</div>
                <div id="alice" style={{width: "300px", heidth: "300px"}}>
