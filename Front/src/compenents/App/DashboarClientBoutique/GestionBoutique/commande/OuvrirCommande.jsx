...
const handleModifierCommande = () => {
    ...
    useEffect(() => {
        ...
        const fetchCommande = async () => {
            try { // permet de récupèrer une commande (par son Id), d'un utilisateur connécter !
                const token = localStorage.getItem('token');
                const response = await fetch(`http://localhost:3000/api/get/commande/utilisateur/${commandeId}`, {
                    method: 'GET',
                    headers: {
    ...
    return (
        ...
        <div id="commande" className="col-md-11  mx-auto graylogo rounded p-3 mt-5">
        <section>
            <div>
