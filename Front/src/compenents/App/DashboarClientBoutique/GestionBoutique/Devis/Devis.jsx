...
import AfficherDevis from './AfficherDevis.jsx';
import ReserveForUser from '../../../../AuthSecure/ReservForUser.jsx';


const Devis = ({produit, index}) => {
...
const retirerDuDevis = (produit_id) => {
...
const filteredProduits = produits.filter(produit => produit.statut === 1);
  ...
  return ( 
    ...
    <section className="container  graylogo p-4 mt-5 rounded-4 mx-auto" style={{ marginBottom:"" }}>
        <h2 className="text-center mx-auto rounded-3 p-3">Vous souhaitez obtenir un devis :</h2>
              ...
              <div className="card border mb-3">
                <div className="card-body ">
                  ...
                  {produit.photos && produit.photos.length > 0 ? (
                        ...
                        <Button onClick={() => ajouterAuDevis(produit)} className='d-flex gap-3 mx-auto '>
                            <span onClick={(e) => {e.stopPropagation(); retirerDuDevis(produit.produit_id)}} style={{ fontSize: "24px", backgroundColor: "black", padding: "3px" }} >&#8681;</span>
                            ...
                            <span onClick={(e) => {e.stopPropagation(); ajouterAuDevis(produit)}} style={{ fontSize: "24px",  backgroundColor: "black", padding: "3px" }}>&#8679;</span>
                        </Button>
