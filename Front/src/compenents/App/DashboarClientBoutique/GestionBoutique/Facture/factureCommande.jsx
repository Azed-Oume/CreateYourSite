...
const FactureCommande = () => {
    ...
    return (
        ...
        <h3 className='p-3 text-center rounded'> {` Facture numéro : ${Facture}${data.commande.numero_commande} `} </h3>
                <Row>
      ...
      <FactureIsVisible panier={panier} totalFacture={totalCommande} quantiteProduits={quantiteProduits} totalProduits={totalProduits} />
        </>
    );
};
