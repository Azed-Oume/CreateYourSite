                ...
                <section id="facture" className="container  graylogo p-4 mt-5 rounded-4 mx-auto">
                    ...
                    <Form>
                        ...
                        <section className='bg-white '>
                            <p className='text-center p-2'>Validité de la facture : {validateFacture}</p>
                        </section>
                    ...
                    <div className="text-center mt-3">
                        ...
                        Sauvegarder et télécharger la facture.PDF
                        </Button>
                    </div>
                    <section className="mt-4">
                        <footer style={{ fontSize: '10px' }} className='bg-white p-2'>
                            <article >
                                <h4 className='text-center rounded p-2'>
                                    ...
                                    <address className="d-flex flex-wrap col-md-12 mb-1">
                                        ...
                                        <p className='mb-1'><strong>Validité de la facture :</strong> {validateFacture} - </p> 
                            ...
                            <article>
                                ...
                                <p className='mb-1'>
                                    <strong>Acceptation :</strong> L'acceptation du facture par voie électronique vaut acceptation expresse du client. Conformément à l'article 1369-2 du Code civil, ce facture, validé par voie électronique, constitue un écrit électronique et a, entre les parties, la même valeur probante qu'un document papier.
                                </p>
                            </article>
                        </footer>
                    </section>
