...
//         {
//             src: wireframe2,
//             text1: "Étape 3: Nous intégrons vos modifications au projet.",
//             text2: "Étape 4: Nous restons à votre écoute pour toute autre demande ou ajustement.",
//         },
//         {
//             src: wireframe3,
//             text1: "Étape 5: Nous vous soumettons la prémaquette une fois terminée.",
...
//                                                     <h3 className="fs-4 text-black fw-bold col-md-12 p-3">{image.text1}</h3>
//                                                     <img src={image.src} style={{ width: "auto", maxHeight: "600px" }} className="d-block w-100 img-fluid" alt={`Slide ${index + 1}`} />
