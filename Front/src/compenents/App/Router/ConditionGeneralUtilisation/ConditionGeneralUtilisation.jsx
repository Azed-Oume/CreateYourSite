...
import DeleteArticle from '../../Article/DeleteArticle.jsx';
import ReadArticles from '../../Article/ReadArticle.jsx';
import AddComment from '../../Article/AddComment.jsx';


const ConditionGeneralUtilisation = () => {
    return (
      <section className="container col-md-10 rounded-4 graylogo pt-4 text-white mt-5" >
        <h2 className="h2 text-center border border-2 rounded-3 p-2">Conditions Générales d'Utilisation</h2>
        <div className="container rounded-3 p-2 mt-4 ">
          <h5 className="fw-bold rounded-3 p-2">Article 1: CGU</h5>
          ...
          <h5 className="fw-bold rounded-3 p-2">Article 2: Propriété Intellectuelle</h5>
          <p className="border border-2 rounded-3 p-2">
          ...
          <h5 className="fw-bold rounded-3 p-2">Article 3: Utilisation Autorisée</h5>
          <p className="border border-2 rounded-3 p-2">
          ...
          <h5 className="fw-bold rounded-3 p-2">Article 4: Comportement de l'Utilisateur</h5>
          <p className="border border-2 rounded-3 p-2">
          ...
          <h5 className="fw-bold rounded-3 p-2">Article 5: Protection des Données Personnelles</h5>
          <p className="border border-2 rounded-3 p-2">
          ...
          <h5 className="fw-bold rounded-3 p-2">Article 6: Modifications des CGU</h5>
          <p className="border border-2 rounded-3 p-2">
          ...
          <h5 className="fw-bold rounded-3 p-2">Article 7: Résiliation</h5>
          <p className="border border-2 rounded-3 p-2">
          ...
          <h5 className="fw-bold rounded-3 p-2">Article 8: Limitation de Responsabilité</h5>
          <p className="border border-2 rounded-3 p-2">
          ...
          <h5 className="fw-bold rounded-3 p-2">Article 9: Juridiction</h5>
          <p className="border border-2 rounded-3 p-2">
          ...
          <h5 className="fw-bold rounded-3 p-2">Article 10: Contact</h5>
          <p className="border border-2 rounded-3 p-2">
