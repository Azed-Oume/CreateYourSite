...
//                                     <Nav.Link className="text-white fw-bold  " as={Link} to="/Utilisateurs" aria-label="Produits en attente de mise en vente.">Utilisateurs</Nav.Link>
//                                 </div>
//                                 {/* )} */}
//                             {/* </div> */}
//                         </Nav>
                            ...
                            <div className='d-flex flex-wrap gap-3 fs- col-md-12 mx-auto m-2 border-bottom' style={{ fontSize: "10px" }}>
                                {headerVisible && (
                                    <>
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-accueil">Aller à l'accueil</Tooltip>}
                                        >
                                            <Nav.Link role="menuitem" className='text-white fw-bold' as={Link} to="/" aria-label="Aller à l'accueil">Accueil</Nav.Link>
                                        </OverlayTrigger>
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-prestations">Voir mes prestations</Tooltip>}
                                        >
                                        ...
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-boutique">Accéder à la boutique</Tooltip>}
                                        >
                                        ...
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-devis">Faire un devis en 2 minutes</Tooltip>}
                                        >
                                        ...
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-commande">Faire une commande en 2 minutes</Tooltip>}
                                        >
                                        ...
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-contact">Page pour contacter le responsable du site</Tooltip>}
                                        >
                                ...
                                <div className='d-flex flex-wrap gap-3 fs- col-md-12 mx-auto m-2 border-bottom' style={{ fontSize: "10px" }}>
                                    <>
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-ajout-photo">Ajouter photo au Portfolio</Tooltip>}
                                        >
                                        ...
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-ajout-produit">Ajouter un Produit</Tooltip>}
                                        >
                                        ...
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-ajout-categorie">Ajouter une Catégorie</Tooltip>}
                                        >
                                        ...
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-produits">Voir Mes Produits</Tooltip>}
                                        >
                                        ...
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-reserve">Produits en attente de mise en vente</Tooltip>}
                                        >
                                        ...
                                        <OverlayTrigger
                                            placement="bottom"
                                            overlay={<Tooltip id="tooltip-utilisateurs">Gestion des Utilisateurs</Tooltip>}
                                        >
                        ...
                        <Nav className="mx-auto fw-bold text-center" onClick={closeMenu} style={{ fontSize: "10px" }}>
                            {isVisible ? (
                                <>
                                    <OverlayTrigger
                                        placement="bottom"
                                        overlay={<Tooltip id="tooltip-inscription">Pour s'inscrire</Tooltip>}
                                    >
                                        <Nav.Link role="menuitem" className='text-white fw-bold' as={Link} to="/Inscription" aria-label="Pour s'inscrire">Inscription</Nav.Link>
                                    </OverlayTrigger>
                                    <OverlayTrigger
                                        placement="bottom"
                                        overlay={<Tooltip id="tooltip-connexion">Connexion</Tooltip>}
                                    >
                                ...
                                <OverlayTrigger
                                    placement="bottom"
                                    overlay={<Tooltip id="tooltip-deconnexion">Déconnexion</Tooltip>}
                                >
                                    <Button
                                        variant=""
                                        className={`text-white fw-bold ${selectedButton === "Déconnexion" ? "active" : ""}`}
