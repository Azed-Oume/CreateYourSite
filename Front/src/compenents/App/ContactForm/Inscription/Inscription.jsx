...
const Inscription = () => {
  ...
  const validateStep = (currentStep) => {
    switch (currentStep) {
      ...
      case 2:
        return formData.societe && formData.siret && formData.numero_tva && formData.rue && formData.ville && formData.code_postal;
      case 3:
    ...
    switch (step) {
      ...
      case 2:
        return (
          <>
            <FormGroup className="col-md-6 mx-auto">
              <FormLabel htmlFor="societe" className="form-control bg-secondary text-white fw-bold mb-2">Société</FormLabel>
              <FormControl
                type="text"
                name="societe"
            ...
            <FormGroup className="col-md-6 mx-auto">
              <FormLabel htmlFor="siret" className="form-control bg-secondary text-white fw-bold mb-2">Siret</FormLabel>
              <FormControl
                type="text"
                name="siret"
            ...
            <FormGroup className="col-md-6 mx-auto">
              <FormLabel htmlFor="numero_tva" className="form-control bg-secondary text-white fw-bold mb-2">Numéro TVA</FormLabel>
              <FormControl
                type="text"
                name="numero_tva"
  ...
  return (
    <Form className="graylogo col-md-9 mx-auto" onSubmit={handleSubmit}>
      <h2 className="col-md-12 fs-3 fw-bold text-dark text-center rounded mb-2 p-2 ">Inscription</h2>
